...
import imgBanner from "./images/LYRIC1.webp"
import img1 from "./images/LYRIC22.webp"
import img2 from "./images/LYRIC1.webp"

import ClinaryReverseInfo from '../components/ClinaryReverseInfo'
import CuisinesCarousel from '../components/CuisinesCarousel'
import lyric from "./images/LYRIC1.webp"
...
const page = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
      <BannerDark img={imgBanner} span="ITALIAN CUISINE AT ITS FINEST" header="Lyric" text="Enjoy a various amount of dining options from around the world."/>
