...
import imgBanner from "./images/bellaazura.webp"
import img1 from "./images/bellaazura.webp"
import img2 from "./images/bellaazura.webp"
...
const page = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
      <BannerDark img={imgBanner} span="ITALIAN CUISINE AT ITS FINEST" header="Bella Azura Restaurant" text="Enjoy a various amount of dining options from around the world."/>
