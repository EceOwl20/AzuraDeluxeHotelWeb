...
import imgBanner from "./images/pastane2.webp"
import img1 from "./images/Pataserrie.webp"
import img2 from "./images/pastane1.webp"
import img3 from "./images/Pateserrie2.webp"
...
import patisserie from "./images/pastane1.webp"
import mazurka from "../mazurka/images/mazurka1.webp"
...
const page = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
      <BannerDark img={imgBanner} span="ITALIAN CUISINE AT ITS FINEST" header="Patisserie" text="Enjoy a various amount of dining options from around the world."/>
