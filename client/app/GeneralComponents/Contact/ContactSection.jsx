...
import imgBackground from "./images/contactbg.jpg"
import LeafSvg from '../Header/Icons/LeafSvg'
import minigallery from "./images/azuragallery.png"
      ...
      <div className='flex flex-col md:flex-row w-[95%]  md:w-[88%] lg:w-[80%] items-center justify-center bg-white h-[85%] lg:h-[88%] max-w-[1440px] gap-[20px]'>
        ...
        <div className='flex h-[39%] md:h-auto w-[90%] md:w-[45%] lg:w-[39%] font-jost text-black items-center md:items-start justify-center '>
           ...
           <span className=' text-[12px] font-medium leading-[14px] uppercase tracking-[0.48px] mt-[10%] md:mt-0'>Follow us for more</span>
            <h2 className='font-marcellus font-normal text-[32px] lg:text-[48px] leading-[150%] lg:leading-[57.6px] capsizedText3 lg:capsizedText2'>@AzuraDeluxeResort</h2>
