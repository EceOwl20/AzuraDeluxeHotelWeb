...
import img9 from "../images/alanyakalesi.png"
...
import img19 from "../images/sideapollon.png"
import img20 from "../images/manavgatwaterfall.png"
import img21 from "../images/dim.png"

const resimler = [img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15,img16,img17,img18, img19, img20, img21]

export default function GeziRehberiPage() {
    const t = useTranslations('ExploreAlanya');

  const geziVerileri = Array.from({ length: 21 }, (_, i) => ({
  baslik: t(`title${i + 1}`),
