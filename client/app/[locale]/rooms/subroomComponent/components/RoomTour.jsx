...
const RoomTour = ({span,header,text, link}) => {
  return (
    <div className='flex w-screen h-auto items-center justify-center max-w-[1440px]'>
      <div className='flex flex-col w-[87.79%] md:w-[91.4%] lg:w-[76.8%] items-center justify-center gap-[30px] lg:gap-[50px]  max-w-[1400px] font-jost'>

       <div className='flex flex-col items-start justify-center gap-[15px] md:gap-[25px] lg:gap-[35px] text-black text-start w-full ml-[20px]'>
       <span className='text-[12px]  font-medium leading-[14px] uppercase tracking-[0.48px]'>{span}</span>
       <h2 className='text-[28px] md:text-[32px] lg:text-[44px] font-marcellus font-normal leading-[120%] lg:leading-[57.6px] lg:capsizedText2'>{header}</h2>
