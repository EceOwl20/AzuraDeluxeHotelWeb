...
const trainings = [
  { href: "/documents/YanginEgitimiAzura.pptx", label: "Yangın Eğitimi" },
  { href: "/documents/TEHLİKELİMADDEEGİTİMİAzure.pptx", label: "Tehlikeli Madde Eğitimi" },
  { href: "/documents/KimyasalEgitimiAzure.pptx", label: "Kimyasal Eğitimi" },
  { href: "/documents/GdaGuvenligiEgitimiAzure.pptx", label: "Gıda Güvenliği Eğitimi" },
  { href: "/documents/EngelliBireylerileiletisimEgitimiAzure.pptx", label: "Engelli Bireyler İle İletişim Eğitimi" },
  { href: "/documents/cocukistismariegitimiAzure.pptx", label: "Çocuk İstismarı Eğitimi" },
  { href: "/documents/Alkol-MaddeEgitimiAzure.pptx", label: "Alkol Madde Eğitimi" },
];
