      ...
      <div className="flex ">
        {cuisines.map((room) => (
          ...
          // mobile iphone kayma var
            key={room.id}
            className="flex-[0_0_80%] md:flex-[0_0_70%] lg:flex-[0_0_70%] xl:flex-[0_0_80.5%] min-w-0 mr-[1.8%] max-h-[500px]" 
          >
            <div className="flex flex-col w-full items-start text-start justify-center gap-[15px] md:gap-[25px] font-jost text-black ">
              <Image src={room.img} alt={room.title} width={room.img.width} height={room.img.height}  className="object-cover object-center" />
